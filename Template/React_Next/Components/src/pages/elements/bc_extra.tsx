        ...
        <>
            ...
            <Row>
                ...
                <Col sm={12}>
                    <Card>
                        <div className="card-header">
                            <h5>Colored links <span className="badge bg-danger">NEW</span></h5>
                            <p className="mb-0">You can use the <code>.link-*</code> classes to colorize links. these classes have a
                                <code>:hover</code> and
                                <code>:focus</code> state.
                            </p>
                        </div>
                        <Card.Body>
                            <Link href="#" className="me-3 link-primary">Primary link</Link>
                            <Link href="#" className="me-3 link-secondary">Secondary link</Link>
                            <Link href="#" className="me-3 link-success">Success link</Link>
                            <Link href="#" className="me-3 link-danger">Danger link</Link>
                            <Link href="#" className="me-3 link-warning">Warning link</Link>
                            <Link href="#" className="me-3 link-info">Info link</Link>
                            <div className="bg-white px-3 py-2 d-inline-block rounded">
                                <Link href="#" className="me-0 link-dark">Dark link</Link>
                            </div>
                            <div className="bg-dark px-3 py-2 d-inline-block rounded">
                                <Link href="#" className="me-0 link-light">Light link</Link>
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col sm={12}>
                    <Card>
                        <div className="card-header">
                            <h5>Text selection <span className="badge bg-danger">NEW</span></h5>
                            <p className="mb-0">Change the way in which the content is selected when the user interacts with it. </p>
                        </div>
                        <div className="card-body">
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>User select all</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="user-select-all">This paragraph will be entirely selected when clicked by the user.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>User select auto</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="user-select-auto">This paragraph has default select behavior.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>User select none</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                ...
                <Col sm={12}>
                    <Card>
                        <div className="card-header">
                            <h5>Line height <span className="badge bg-danger">NEW</span></h5>
                            <p className="mb-0">Change the line height with <code>.lh-*</code> utilities.</p>
                        </div>
                        <div className="card-body">
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>Line height 1</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="lh-1">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec sed
                                        odio dui. Cras mattis pannenkoek purus sit
                                        amet fermentum.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>Line height small</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="lh-sm">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec sed
                                        odio dui. Cras mattis pannenkoek purus sit
                                        amet fermentum.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>Line height base</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="lh-base">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec
                                        sed odio dui. Cras mattis pannenkoek purus sit
                                        amet fermentum.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-2 col-sm-12 text-lg-end"><b>Line height large</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="lh-lg">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Donec sed
                                        odio dui. Cras mattis pannenkoek purus sit
                                        amet fermentum.</p>
                                </div>
                            </Row>
                ...
                <Col sm={12}>
                    <Card>
                        <div className="card-header">
                            <h5>Pointer events <span className="badge bg-danger">NEW</span></h5>
                            <p className="mb-0">Bootstrap provides <code>pe-none</code> and <code>pe-auto</code> classes to prevent or
                                add element interactions.</p>
                        </div>
                        <div className="card-body">
                            <Row>
                                <label className="col-lg-3 col-sm-12 text-lg-end"><b>Pointer events none</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p><a href="#" className="pe-none">This link</a> can not be clicked.</p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-3 col-sm-12 text-lg-end"><b>Pointer events auto</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p><a href="#" className="pe-auto">This link</a> can be clicked (this is default behaviour). </p>
                                </div>
                            </Row>
                            <Row>
                                <label className="col-lg-3 col-sm-12 text-lg-end"><b>Pointer events combine</b></label>
                                <div className="col-lg-6 col-md-10 col-sm-12">
                                    <p className="pe-none"><a href="#">This link</a> can not be clicked because the
                                        <code>pointer-events</code> property is inherited from its parent.
                                        However, <a href="#" className="pe-auto">this link</a> has a <code>pe-auto</code> class and can be
                                        clicked.
                                    </p>
                                </div>
                            </Row>
                ...
                <Col sm={12}>
                    <Card>
                        <div className="card-header">
                            <h5>Position values <span className="badge bg-danger">NEW</span></h5>
                            <p className="mb-0">Arrange elements easily with the edge positioning utilities, The format is
                        ...
                        <div className="card-body">
                            ...
                            <p className="mb-0">In addition, you can also center the elements with the transform utility class
                            ...
                            <div className="p-4 my-3">
                                <div className="position-relative bg-body" style={{ height: "250px" }}>
                                    ...
                                    <div
                                        className="hei-40 wid-40 rounded bg-secondary position-absolute top-50 start-100 translate-middle"
                                    ...
                                    <div
                                        className="hei-40 wid-40 rounded bg-secondary position-absolute top-100 start-50 translate-middle"
                                        data-bs-toggle="tooltip" title="position-absolute top-100 start-50 translate-middle"></div>
                                    <div
                                        className="hei-40 wid-40 rounded bg-secondary position-absolute top-100 start-100 translate-middle"
                                        data-bs-toggle="tooltip" title="position-absolute top-100 start-100 translate-middle"></div>
                                </div>
                            </div>
                            <hr />
                            <h5>Examples</h5>
                            <p className="mb-0">Here are some real life examples of these classes.</p>
                            <div className="p-3 p-sm-5 d-flex justify-content-between">
                            ...
                            <hr />
                            <p className="mb-0">You can use these classes with existing components to create new ones. Remember that
                        ...
                        <div className="card-body">
                            <div className="row g-4">
                                <Col sm={12}>
                                    <h5>Border color</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-primary"
                                        data-bs-toggle="tooltip" title="border-primary"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary"
                                        data-bs-toggle="tooltip" title="border-secondary"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-success"
                                        data-bs-toggle="tooltip" title="border-success"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-danger"
                                        data-bs-toggle="tooltip" title="border-danger"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-warning"
                                        data-bs-toggle="tooltip" title="border-warning"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-info"
                                        data-bs-toggle="tooltip" title="border-info"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-light"
                                        data-bs-toggle="tooltip" title="border-light"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark"
                                        data-bs-toggle="tooltip" title="border-dark"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-white"
                                        data-bs-toggle="tooltip" title="border-white"></span>
                                </Col>
                                <div className="col-md-6 additive">
                                    <h5>Additive</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border-dark border"
                                        data-bs-toggle="tooltip" title="border"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border-dark border-top"
                                        data-bs-toggle="tooltip" title="border-top"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border-dark border-end"
                                        data-bs-toggle="tooltip" title="border-end"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border-dark border-bottom"
                                        data-bs-toggle="tooltip" title="border-bottom"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border-dark border-start"
                                        data-bs-toggle="tooltip" title="border-start"></span>
                                </div>
                                <div className="col-sm-6">
                                    <h5>Subtractive</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-0"
                                        data-bs-toggle="tooltip" title="border border-0"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-top-0"
                                        data-bs-toggle="tooltip" title="border border-top-0"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-end-0"
                                        data-bs-toggle="tooltip" title="border border-end-0"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-bottom-0"
                                        data-bs-toggle="tooltip" title="border border-bottom-0"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-start-0"
                                        data-bs-toggle="tooltip" title="border border-start-0"></span>
                                </div>
                                <div className="col-sm-6">
                                    <h5>Border width</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-1"
                                        data-bs-toggle="tooltip" title="border border-1"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-2"
                                        data-bs-toggle="tooltip" title="border border-2"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-3"
                                        data-bs-toggle="tooltip" title="border border-3"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-4"
                                        data-bs-toggle="tooltip" title="border border-4"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark border-5"
                                        data-bs-toggle="tooltip" title="border border-5"></span>
                                </div>
                                <div className="col-sm-6">
                                    <h5>Border radius Sizes</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark rounded-sm"
                                        data-bs-toggle="tooltip" title="rounded-sm"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-dark rounded-lg"
                                        data-bs-toggle="tooltip" title="rounded-lg"></span>
                                </div>
                                <Col sm={12}>
                                    <h5>Border-radius</h5>
                                    <hr />
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded"
                                        data-bs-toggle="tooltip" title="rounded"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-top"
                                        data-bs-toggle="tooltip" title="rounded-top"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-right"
                                        data-bs-toggle="tooltip" title="rounded-right"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-bottom"
                                        data-bs-toggle="tooltip" title="rounded-bottom"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-left"
                                        data-bs-toggle="tooltip" title="rounded-left"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-circle"
                                        data-bs-toggle="tooltip" title="rounded-circle"></span>
                                    <span className="hei-75 wid-120 bg-body d-inline-block me-2 border border-secondary rounded-pill"
                                        data-bs-toggle="tooltip" title="rounded-pill"></span>
                                    <span className="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-0"
                        ...
                        <div className="card-body">
                            <div className="row g-4">
                                <div className="col-md-6">
                                    ...
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1" title="margin-0">.m-0</label>
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1" title="margin-5">.m-5</label>
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Margin bottom</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Margin left</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Margin right</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                ...
                                <div className="col-md-6">
                                    ...
                                    <h6 className="mb-0 mt-3">Padding top</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Padding bottom</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Padding left</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                    ...
                                    <h6 className="mb-0 mt-3">Padding right</h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                ...
                                <div className="col-md-6">
                                    <h6 className="mb-0 mt-3">Width </h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                                ...
                                <div className="col-md-6">
                                    <h6 className="mb-0 mt-3">Height </h6>
                                    <hr className="my-2" />
                                    <label data-bs-toggle="tooltip" className="badge bg-light-secondary p-1"
                ...
                <Col sm={12}>
                    <Card>
                        ...
                        <div className="card-body pc-component">
                            ...
                            <div className="shadow-sm p-3 mb-3 rounded">Small shadow</div>
                            <div className="shadow p-3 mb-3 rounded">Regular shadow</div>
                            <div className="shadow-lg p-3 mb-3 rounded">Larger shadow</div>
                        </div>
                    </Card>
                </Col>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-8">
                                    <div className="ratio ratio-16x9">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/1jWCXJfxHQM?rel=0"
                                        ></iframe>
                                    </div>
                                </div>
                            </div>
...
BCExtra.getLayout = (page: ReactElement) => {
    return (
        <Layout>
            {page}
        </Layout>
