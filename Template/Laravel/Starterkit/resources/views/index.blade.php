        ...
        <div class="container">
            ...
            <div class="row g-4 text-center ">
                <div class="col-lg-4 col-md-6">
                    ...
                    <a href="/demo/layout-vertical" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">Dark Version <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                    ...
                    <a href="/demo/layout-horizontal" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">RTL Version <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card layout-card">
                        <div class="card-body">
                            <a href="/demo/layout-horizontal" target="_blank">
                                <img src="{{ URL::asset('build/images/landing/preview-page-landing.jpg') }}" alt="img"
                                    class="img-fluid border">
                            </a>
                        </div>
                    </div>
                    <a href="/demo/layout-horizontal" target="_blank"
                        class="h5 d-flex align-items-center justify-content-center gap-2">Landing Page <i
                            class="ti ti-link text-primary f-22"></i></a>
                </div>
