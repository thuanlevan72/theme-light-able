      ...
      <div class="card-body">
        <div id="cke5-inline-demo">
          ...
          <div class="ck-content ck-content1" data-inline-inject="true">
            ...
            <h4>Valletta</h4>
            <figure class="image image-style-side"><img alt="Picture of a sunlit facade of a Maltan building." src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/malta.jpg">
              <figcaption>It's siesta time in Valletta.</figcaption>
            </figure>
            <p>The capital city of <a href="https://en.wikipedia.org/wiki/Malta" target="_blank" rel="noopener">Malta</a> is the top
