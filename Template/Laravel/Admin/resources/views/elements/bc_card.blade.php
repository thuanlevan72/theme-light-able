...
@section('breadcrumb-text', 'Bootstrap’s cards provide a flexible and extensible content container with multiple variants and options.')
            ...
            <div class="col-md-6 col-xxl-4">
              ...
              <div class="pc-component">
                <div class="card">
                  ...
                  <img class="img-fluid card-img-bottom" src="{{ URL::asset('build/images/light-box/l3.jpg') }}"
                    alt="Card image cap">
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-12">
              ...
              <div class="pc-component">
                <div class="card overflow-hidden">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src="{{ URL::asset('build/images/light-box/l3.jpg') }}" class="img-fluid rounded-md-start" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
