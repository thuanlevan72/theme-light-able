    ...
    <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="media align-items-center mt-3">
                  <img class="img-radius d-none d-sm-inline-flex me-3 wid-40 rounded-circle" src="{{ URL::asset('build/images/user/avatar-1.jpg') }}" alt="User image">
      ...
      <div class="col-lg-4 col-xxl-3">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="card border-0 mb-0 shadow-none drp-upgrade-card social-community-card" style="background-image: url(/build/images/application/img-community-bg.jpg)">
              <div class="card-body">
