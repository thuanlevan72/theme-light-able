        ...
        <div class="d-sm-flex align-items-center mb-4">
          ...
          <ul class="list-inline ms-auto my-1">
            ...
            <li class="list-inline-item align-bottom">
              <a href="#" class="d-xxl-none btn btn-link-secondary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_mail_filter">
        ...
        <div class="row">
            ...
            <div class="card product-card">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-1.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card product-card">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-6.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card product-card">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-7.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card product-card">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-8.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card product-card">
              <div class="card-img-top">
                <a href="{{ url('application/ecom_product-details') }}">
                  <img src="{{ URL::asset('build/images/application/img-prod-9.jpg') }}" alt="image" class="img-prod img-fluid">
                </a>
                <div class="card-body position-absolute end-0 top-0">
                  <div class="form-check prod-likes">
                    <input type="checkbox" class="form-check-input">
