...
<nav class="navbar navbar-expand-md navbar-light default">
  <div class="container">
    <a class="navbar-brand" href="/">
      <img src="/images/logo-dark.svg" alt="logo" class="logo-lg" />
    </a>
    <button
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-start">
        ...
        <li class="nav-item px-1">
          <a class="nav-link active" href="bc_alert">Components</a>
        </li>
        <li class="nav-item px-1">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0 align-items-start">
        ...
        <li class="nav-item">
        <a href="https://phoenixcoded.com/item/light-able-bootstrap-admin-dashboard/" target="_blank" class="btn btn-primary">Get Light able <i class="ph-duotone ph-arrow-square-out"></i></a>
        </li>
      </ul>
    </div>
  </div>
