        ...
        <div class="dropdown-header d-flex align-items-center justify-content-between">
          ...
          <ul class="list-inline ms-auto mb-0">
            <li class="list-inline-item">
              <a href="mail" class="avtar avtar-s btn-link-hover-primary">
            ...
            <li class="list-group-item">
              ...
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="/images/user/avatar-2.jpg" alt="user-image" class="user-avtar avtar avtar-s" />
                </div>
            ...
            <ul class="list-group list-group-flush w-100">
              <li class="list-group-item">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/user/avatar-2.jpg" alt="user-image" class="wid-50 rounded-circle" />
                  </div>
