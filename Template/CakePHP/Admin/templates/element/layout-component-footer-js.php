...
<footer class="footer">
    ...
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img src="/images/logo-dark.svg" alt="image" class="footer-logo img-fluid mb-3" />
                    <p class="mb-4">Since 2017, More than 50K+ Developers trust the CodedThemes Digital Product. Mantis
                ...
                <div class="col-auto my-1">
                    <ul class="list-inline footer-sos-link mb-0">
                        <li class="list-inline-item">
                            <a href="https://fb.com/codedthemes"><i class="ph-duotone ph-facebook-logo f-20"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
