...
<head>
  ...
  <link href="/css/plugins/swiper-bundle.css" rel="stylesheet">
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light"
  ...
  <header id="home">
    ...
    <nav class="navbar navbar-expand-md navbar-light default">
      <div class="container">
        <a class="pc-navbar-brand" href="/">
          <img src="/images/logo-dark.svg" alt="logo" class="logo-lg landing-logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav ms-auto mt-lg-0 mt-2 mb-2 mb-lg-0 align-items-start">
            ...
            <li class="nav-item px-1">
              <a class="nav-link" href="bc_alert">Components</a>
            </li>
            <li class="nav-item px-1">
    ...
    <div class="container-fluid">
      <div class="bg-dark mx-sm-3 home-section">
        <img src="/images/landing/img-header-bg.svg" alt="background shape" class="img-fluid img-header-bg">
              ...
              <div class="swiper language-slides">
                <div class="swiper-wrapper">
                  ...
                  <a href="#" class="language-badge text-white">
                    <img src="/images/landing/icons/mui.svg" class="me-1" alt="material ui icon">
                    Material-UI
                  </a>
                </div> -->
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-bs.svg" class="me-1" alt="react icon">
                      Bootstrap
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-react.svg" class="me-1" alt="react icon">
                      React
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-vue.svg" class="me-1" alt="react icon">
                      Vue.js
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-laravel.svg" class="me-1" alt="react icon">
                      Laravel
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-node.svg" class="me-1" alt="react icon">
                      Node.js
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-django.svg" class="me-1" alt="react icon">
                      Django
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-net.svg" class="me-1" alt="react icon">
                      ASP
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-cakephp.svg" class="me-1" alt="react icon">
                      CakePHP
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-mvc5.svg" class="me-1" alt="react icon">
                      MVC5
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/techcard-figma.svg" class="me-1" alt="react icon">
                      Figma
                    </a>
                  </div>
                  <!-- <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/icons/figma.svg" class="me-1" alt="figma icon">
                      Figma
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/icons/react.svg" class="me-1" alt="react icon">
                      React
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/icons/js.svg" class="me-1" alt="js icon">
                      Javascript
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#" class="language-badge text-white">
                      <img src="/images/landing/icons/ts.svg" class="me-1" alt="typscript icon">
                      Typescript
                    </a>
                  </div>
                  <div class="swiper-slide">
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-bs.svg" alt="images" class="tech-img">
                  </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.3s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-react.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.4s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-vue.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.5s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-laravel.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.6s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-node.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.7s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-django.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.8s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-net.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.9s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-cakephp.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.9s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-mvc5.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card technology-card wow animate__fadeInRight section-title" data-wow-delay="0.9s">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img src="/images/landing/techcard-figma.svg" alt="images" class="tech-img">
                  </div>
                  <div class="flex-grow-1 mx-2">
    ...
    <div class="container">
      ...
      <div class="row g-4 text-center ">
          ...
          <div class="card layout-card">
            <div class="card-body">
              <a href="/index" target="_blank">
                <img src="/images/landing/preview-layouts-vertical.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/layout-vertical" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Vertical <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/layout-horizontal" target="_blank">
                <img src="/images/landing/preview-layouts-horizontal.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/layout-compact" target="_blank">
                <img src="/images/landing/preview-layouts-compact.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/layout-compact" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Compact <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/layout-2" target="_blank">
                <img src="/images/landing/preview-layouts-creative.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/layout-2" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Creative <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/layout-tab" target="_blank">
                <img src="/images/landing/preview-layouts-tab.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/layout-tab" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Tab <i class="ti ti-link text-primary f-22"></i></a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row g-4 text-center ">
          ...
          <div class="card layout-card">
            <div class="card-body">
              <a href="invoice-list" target="_blank">
                <img src="/images/landing/preview-app-invoice.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          ...
          <div class="card layout-card">
            <div class="card-body">
              <a href="/social-media" target="_blank">
                <img src="/images/landing/preview-app-social.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          ...
          <div class="card layout-card">
            <div class="card-body">
              <a href="mail" target="_blank">
                <img src="/images/landing/preview-app-inbox.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/ecom_product" target="_blank">
                <img src="/images/landing/preview-app-ecommerce.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/ecom_product" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">E-commerce <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/gallery-grid" target="_blank">
                <img src="/images/landing/preview-app-gallery.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/gallery-grid" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Gallery <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="card layout-card">
            <div class="card-body">
              <a href="calendar" target="_blank">
                <img src="/images/landing/preview-app-calendar.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          ...
          <div class="card layout-card">
            <div class="card-body">
              <a href="chat" target="_blank">
                <img src="images/landing/preview-app-chat.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row g-4 text-center ">
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="bc_alert" target="_blank">
                <img src="/images/landing/lay-vertical.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="bc_alert" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Components <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.4s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/login-v1" target="_blank">
                <img src="/images/landing/preview-important-auth-page.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/login-v1" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Auth Pages <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="w_statistics" target="_blank">
                <img src="/images/landing/preview-important-widgets.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="w_statistics" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Widgets <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.4s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/form2_wizard" target="_blank">
                <img src="/images/landing/preview-important-wizard.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/form2_wizard" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Wizard <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="/account-profile" target="_blank">
                <img src="/images/landing/preview-important-account-profile.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="/account-profile" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Account Profile <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.8s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="dt_advance" target="_blank">
                <img src="/images/landing/preview-important-data-table.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="dt_advance" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Data Tables <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="form_elements" target="_blank">
                <img src="/images/landing/preview-important-form.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="form_elements" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Forms <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.8s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="error-404" target="_blank">
                <img src="/images/landing/preview-important-error.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="error-404" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Error <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="1.0s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="coming-soon" target="_blank">
                <img src="/images/landing/preview-important-coming-soon.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
          <a href="coming-soon" target="_blank" class="h5 d-flex align-items-center justify-content-center gap-2">Coming Soon <i class="ti ti-link text-primary f-22"></i></a>
        </div>
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
          <div class="card layout-card">
            <div class="card-body">
              <a href="contact-us" target="_blank">
                <img src="/images/landing/preview-important-contact.jpg" alt="img" class="img-fluid border">
              </a>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row g-4 text-center ">
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.2s">
          <div class="card layout-card">
            <div class="card-body">
              <img src="images/landing/preview-page-dark.jpg" alt="img" class="img-fluid border">
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.4s">
          <div class="card layout-card">
            <div class="card-body">
              <img src="images/landing/preview-page-rtl.jpg" alt="img" class="img-fluid border">
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 wow animate__fadeInUp" data-wow-delay="0.6s">
          <div class="card layout-card">
            <div class="card-body">
              <img src="images/landing/preview-page-landing.jpg" alt="img" class="img-fluid border">
            </div>
          </div>
    ...
    <div class="container">
      <div class="row g-3">
        <div class="col-md-6 col-lg-4">
          <div class="card border-0 shadow-none wow animate__fadeInUp mb-0"
            data-wow-delay="0.1s">
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-12">
          <div class="card bg-dark counter-block mb-0 wow animate__fadeInUp" data-wow-delay="0.7s">
            <img src="/images/landing/img-counter-bg.svg" alt="img" class="img-fluid img-counter-bg">
        ...
        <div class="col-md-12">
          <div class="row justify-content-center client-block g-lg-4 g-3">
            <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.3s"><img
                src="/images/landing/client-eagames.svg" alt="img" class="img-fluid"></div>
            <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.4s"><img
                src="/images/landing/client-haswent-2.svg" alt="img" class="img-fluid"></div>
            <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.5s"><img
                src="/images/landing/client-crystal-1.svg" alt="img" class="img-fluid"></div>
            <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.6s"><img
                src="/images/landing/client-vodafone.svg" alt="img" class="img-fluid"></div>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-md-4 wow animate__fadeInUp" data-wow-delay="0.2s">
            <img src="/images/logo-dark.svg" alt="image" class="img-fluid mb-3">
            <p class="mb-0">Since 2014, over 6.3K developers have placed their trust in Phoenixcoded's Templates. Light Able is managed by their experienced team of professionals.</p>
          </div>
          <div class="col-md-8">
            <div class="row gy-4">
  ...
  <script src="/js/plugins/swiper-bundle.js"></script>
  <script>
