...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Data Widget')); ?> <?= $this->element('head-css') ?> 
  </head>
  <!-- [Head] end -->
  <!-- [Body] Start -->
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Widget', 'breadcrumbitemactive' =>'Data')); ?>
        <div class="row">
            ...
            <div class="card">
              ...
              <ul class="list-group list-group-flush border-top-0">
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="images/user/avatar-1.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" >
                    </div>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="images/user/avatar-3.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" >
                    </div>
                    <div class="flex-grow-1 mx-2">
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="images/user/avatar-5.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" >
                    </div>
                    <div class="flex-grow-1 mx-2">
                  ...
                  <table class="table table-hover table-borderless mb-0">
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="images/widget/GERMANY.jpg" alt="" class="img-fluid wid-30 rounded-1" >
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="images/widget/USA.jpg" alt="" class="img-fluid wid-30 rounded-1" >
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="images/widget/AUSTRALIA.jpg" alt="" class="img-fluid wid-30 rounded-1" >
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="images/widget/UK.jpg" alt="" class="img-fluid wid-30 rounded-1" >
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="images/widget/BRAZIL.jpg" alt="" class="img-fluid wid-30 rounded-1" >
