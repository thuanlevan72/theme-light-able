...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Carousel')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Carousel', 'text' =>'A slideshow component for cycling through elements—images or slides of text—like a carousel.', 'link' =>'https://getbootstrap.com/docs/5.2/components/carousel/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
                  ...
                  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-1.jpg"
                          alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-2.jpg"
                          alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-3.jpg"
                          alt="Third slide">
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-4.jpg"
                          alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-3.jpg"
              ...
              <div class="card">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-7.jpg"
                          alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-3.jpg"
              ...
              <div class="card">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="images/light-box/l6.jpg"
                          alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/pages/img-gallery-7.jpg"
                          alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="images/slider/img-slide-5.jpg"
                          alt="First slide">
                      </div>
                    </div>
