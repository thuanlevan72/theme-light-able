...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Live Preview')); ?>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light" class="landing-page">
  ...
  <header id="home">
    ...
    <!-- [ Nav ] start -->
    <img src="/images/landing/img-header-bg.svg" alt="img" class="img-fluid img-header-bg" />
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-7 header-content">
          <div class="header-badge wow animate__zoomIn" data-wow-delay="0.6s">
            <span>Chat app</span>
            <img src="images/landing/img-h-badge-bg.svg" alt="img" class="img-fluid" />
          </div>
          ...
          <p class="text-muted f-16 mb-3 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.6s">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.
          </p>
          <div class="wow animate__fadeInUp" data-wow-delay="0.8s">
            <a href="index" class="btn btn-primary">Get Light able <i class="ph-duotone ph-arrow-square-out"></i></a>
          </div>
        </div>
        <div class="col-md-5">
          <div class="wow animate__zoomIn" data-wow-delay="0.8s">
            <img src="images/landing/img-header-moke.png" alt="img" class="img-fluid" />
          </div>
        </div>
      </div>
      </div>
  ...
  <section class="bg-white pb-0">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card bg-dark counter-block wow animate__fadeInUp mb-0" data-wow-delay="0.7s">
              <img src="images/landing/img-customer-bg.svg" alt="img" class="img-fluid img-customer-bg" />
              <div class="card-body p-4 p-md-5">
                <div class="row align-items-center">
                  <div class="col-lg-6 my-3">
                    <h2 class="text-white mb-4">1000 + happy customer</h2>
                    <a href="https://phoenixcoded.com/" class="btn btn-primary" target="_blank"
                      >See more review <i class="ph-duotone ph-arrow-square-out"></i>
                    </a>
                  </div>
                  <div class="col-lg-6 my-3">
    ...
    <section class="bg-white board-section">
      <img src="images/landing/img-dot-bg.png" alt="img" class="img-fluid img-dots-bg" />
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-8 col-xl-6">
            <h2 class="wow animate__fadeInUp section-title" data-wow-delay="0.2s">The most powerful Light able UI Board </h2>
            ...
            <div class="bard-block">
              ...
              <div class="row justify-content-center">
                <div class="col-11 col-sm-9 wow animate__fadeInUp text-center" data-wow-delay="0.4s">
                  <img src="images/landing/img-board.jpg" alt="img" class="img-fluid rounded border" />
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="bg-dark product-section pb-0">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-xl-10">
            <h2 class="text-white wow animate__fadeInUp section-title mb-0" data-wow-delay="0.2s">
              Run your entire business from one single product, built just for moving companies.</h2>
          </div>
          <div class="col-md-8 col-xl-6">
        ...
        <div class="row justify-content-center product-cards-block">
          <div class="col-12 position-relative">
            <img src="images/landing/img-click-prod.png" alt="img" class="img-fluid img-arrow d-none d-lg-inline-block" />
          </div>
          <div class="col-xl-10">
            <div class="row justify-content-center text-center">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center">
          <div class="col-9 wow animate__zoomIn" data-wow-delay="0.4s">
            <img src="images/landing/img-platform.png" alt="img" class="img-fluid" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-primary comminuties-section">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-8 col-xl-6">
            <h2 class="text-white wow animate__fadeInUp section-title" data-wow-delay="0.2s">Trusted by open-source comminuties</h2>
            <p class="text-white text-opacity-75 mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.4s">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
              text ever since the 1500s.</p>
          </div>
            ...
            <div class="swiper comminuties-slides">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="card mb-0">
                    <div class="card-body">
                      <h3>Glad to see the designs and the components cleaness. Quality product with the great documenation. Congratulations
                        for the good work</h3>
                      <p class="my-3 text-primary text-end">- Design Quality</p>
                      <div class="media align-items-start">
                        <div class="flex-shrink-0">
                          <img src="images/user/avatar-1.jpg" alt="user image" class="img-radius" style="width: 40px" />
                        </div>
                  ...
                  <div class="swiper-slide">
                    <div class="card mb-2">
                      <div class="card-body">
                        ...
                        <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
              ...
              <div class="card-body p-4 p-md-5">
                <div class="row align-items-center justify-content-between">
                  <div class="col-lg-4 my-3 text-center text-sm-start">
                    ...
                    <p class="mb-4 text-white text-opacity-50">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                      standard</p>
                  ...
                  <div class="col-lg-6 my-3 counter-block">
                    <div class="swiper price-slides">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <ul
                            class="nav nav-pills price-tabs rounded mb-4 wow animate__fadeInUp"
                            data-wow-delay="0.4s"
                            id="pills-1tab"
                            role="tablist">
                            <li class="nav-item" role="presentation">
                              <button
                                ...
                                id="pills-1home-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-1home"
                                type="button"
                                role="tab"
                                aria-controls="pills-1home"
                                aria-selected="true"
                                >Monthly</button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button
                                class="nav-link"
                                id="pills-1profile-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-1profile"
                                type="button"
                                role="tab"
                          ...
                          <div class="row g-3 text-center align-items-center">
                            <div class="col-sm-6">
                              <div class="tab-content" id="pills-1tabContent">
                                <div
                                  ...
                                  id="pills-1home"
                                  role="tabpanel"
                                  aria-labelledby="pills-1home-tab"
                                  tabindex="0">
                                ...
                                <div
                                  ...
                                  id="pills-1profile"
                                  role="tabpanel"
                                  aria-labelledby="pills-1profile-tab"
                                  tabindex="0">
                            ...
                            <div class="col-sm-6">
                              <ul class="list-unstyled text-start text-white text-opacity-50">
                                ...
                                <li class="my-2"><i class="me-1 ti ti-check text-success"></i> 6 month premium Support </li>
                                <li class="my-2"><i class="me-1 ti ti-check text-success"></i> 1 year updates</li>
                                <li class="my-2"><i class="me-1 ti ti-check text-success"></i> For Non-Paying users only </li>
                              </ul>
                            </div>
                          </div>
                        </div>
                          ...
                          <ul
                            ...
                            <li class="nav-item" role="presentation">
                              <button
                                ...
                                id="pills-2home-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-2home"
                                type="button"
                                role="tab"
                                aria-controls="pills-2home"
                                aria-selected="true"
                                >Monthly</button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button
                                class="nav-link"
                                id="pills-2profile-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-2profile"
                                type="button"
                                role="tab"
                            ...
                            <div class="col-6">
                              <div class="tab-content" id="pills-2tabContent">
                                <div
                                  ...
                                  id="pills-2home"
                                  role="tabpanel"
                                  aria-labelledby="pills-2home-tab"
                                  tabindex="0">
                                ...
                                <div
                                  ...
                                  id="pills-2profile"
                                  role="tabpanel"
                                  aria-labelledby="pills-2profile-tab"
                                  tabindex="0">
                          ...
                          <ul
                            ...
                            <li class="nav-item" role="presentation">
                              <button
                                ...
                                id="pills-3home-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-3home"
                                type="button"
                                role="tab"
                                aria-controls="pills-3home"
                                aria-selected="true"
                                >Monthly</button>
                            </li>
                            <li class="nav-item" role="presentation">
                              <button
                                class="nav-link"
                                id="pills-3profile-tab"
                                data-bs-toggle="pill"
                                data-bs-target="#pills-3profile"
                                type="button"
                                role="tab"
    ...
    <section>
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <img src="images/landing/img-widget.png" alt="img" class="img-fluid wow animate__fadeInUp" data-wow-delay="0.2s" />
          </div>
          <div class="col-md-6">
            <ul class="nav nav-pills widget-tabs rounded mb-4 wow animate__fadeInUp" data-wow-delay="0.4s" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link active"
                  id="pills-home-tab"
                  ...
                  aria-selected="true">Visual report</button>
              </li>
              <li class="nav-item" role="presentation">
                <button
                  class="nav-link"
                  ...
                  aria-selected="false">Statistic</button>
              </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                <h2 class="mb-3 wow animate__fadeInUp" data-wow-delay="0.4s">All widgets designed for different Applications categories</h2>
                <p class="mb-4 wow animate__fadeInUp" data-wow-delay="0.6s">
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                  dummy text ever since the 1500s.</p>
                <div class="wow animate__fadeInUp" data-wow-delay="0.8s">
                  <a href="index" class="btn btn-primary me-2">Explore</a>
                  <a href="index" class="btn btn-outline-secondary">Live preview</a>
                </div>
              </div>
    ...
    <section class="bg-white feature-section">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center g-sm-4 g-3">
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.1s">
              <div class="card-body">
                <div class="media align-items-start">
                  ...
                  <div class="media-body ms-3">
                    ...
                    <p class="mb-0 text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                      standard</p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.2s">
              <div class="card-body">
                <div class="media align-items-start">
                  <div class="avtar bg-light-primary flex-shrink-0">
          ...
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.3s">
              <div class="card-body">
                <div class="media align-items-start">
                  <div class="avtar bg-light-primary flex-shrink-0">
          ...
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.4s">
              <div class="card-body">
                <div class="media align-items-start">
                  <div class="avtar bg-light-primary flex-shrink-0">
          ...
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.5s">
              <div class="card-body">
                <div class="media align-items-start">
                  <div class="avtar bg-light-primary flex-shrink-0">
          ...
          <div class="col-md-6">
            <div class="card border border-secondary border-opacity-25 shadow-none wow animate__fadeInUp mb-0" data-wow-delay="0.6s">
              <div class="card-body">
                <div class="media align-items-start">
                  <div class="avtar bg-light-primary flex-shrink-0">
              ...
              <div class="card-body p-4 p-md-5">
                <div class="row align-items-center">
                  <div class="col-lg-6 my-3">
                    ...
                    <p class="mb-0 text-white text-opacity-50">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                      standard</p>
                  </div>
                  <div class="col-lg-6 my-3">
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-8 col-xl-6">
            ...
            <p class="mt-4 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.2s">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
              text ever since the 1500s.</p>
          </div>
          <div class="col-md-12">
            <div class="row justify-content-center client-block g-5">
              <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.3s"><img src="images/landing/client-eagames.svg" alt="img" class="img-fluid" /></div>
              <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.4s"><img src="images/landing/client-haswent-2.svg" alt="img" class="img-fluid" /></div>
              <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.5s"><img src="images/landing/client-crystal-1.svg" alt="img" class="img-fluid" /></div>
              <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.6s"><img src="images/landing/client-vodafone.svg" alt="img" class="img-fluid" /></div>
              <div class="col-auto wow animate__fadeInRight" data-wow-delay="0.7s"><img src="images/landing/client-eagames.svg" alt="img" class="img-fluid" /></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 wow animate__fadeInUp" data-wow-delay="0.2s">
              ...
              <p class="mb-4">Since 2014, over 6.3K developers have placed their trust in Phoenixcoded's Templates. Light Able is managed by their
