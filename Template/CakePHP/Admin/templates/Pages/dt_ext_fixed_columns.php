...
<html lang="en">
  <!-- [Head] start -->
  <head>
    <?= $this->element('head-page-meta', array('title' => 'FixedColumns')); ?>
    <!-- [Page specific CSS] start -->
    <!-- data tables css -->
    <link rel="stylesheet" href="css/plugins/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="css/plugins/fixedColumns.bootstrap5.min.css">
  ...
  <?= $this->element('body') ?>
    ...
    <section class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'DataTable', 'breadcrumbitemactive' =>'FixedColumns')); ?>
