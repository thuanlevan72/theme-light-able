...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Wizard')); ?>
...
<?= $this->element('body') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Forms', 'breadcrumbitemactive' =>'Wizard')); ?>
                        ...
                        <div class="row mt-4">
                          <div class="col-sm-auto text-center">
                            <div class="position-relative me-3 d-inline-flex">
                              ...
                              <img src="/images/application/img-prod-3.jpg" alt="user-image"
  ...
  <script src="/js/plugins/wizard.min.js"></script>
  <script>
