...
<html lang="en">
  <!-- [Head] start -->
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Basic initialization')); ?> 
  ...
  <?= $this->element('body') ?>
    ...
    <section class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Table', 'breadcrumbitemactive' =>'Basic initialization')); ?>
    ...
    <script type="module">
      import {DataTable} from "/js/plugins/module.js"
