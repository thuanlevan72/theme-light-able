...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Checkout')); ?> <?= $this->element('head-css') ?> 
</head>
<!-- [Head] end -->
<!-- [Body] Start -->
...
<?= $this->element('body') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'E-commerce', 'breadcrumbitemactive' =>'Checkout')); ?>
                        ...
                        <table class="table mb-0" id="pc-dt-simple">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="media align-items-center">
                                  <img src="images/application/img-prod-2.jpg" alt="image"
                            ...
                            <tr>
                              <td>
                                <div class="media align-items-center">
                                  <img src="images/application/img-prod-3.jpg" alt="image"
                                    class="bg-light wid-50 rounded">
                                  <div class="media-body ms-3">
                                    <h5 class="mb-1">Apple MacBook Pro</h5>
                                    <p class="text-sm text-muted mb-0">Dark Red</p>
                            ...
                            <tr>
                              <td>
                                <div class="media align-items-center">
                                  <img src="images/application/img-prod-4.jpg" alt="image"
                                    class="bg-light wid-50 rounded">
                                  <div class="media-body ms-3">
                                    <h5 class="mb-1">Apple MacBook Pro</h5>
                                    <p class="text-sm text-muted mb-0">Dark Red</p>
                    ...
                    <div class="card-body p-0">
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                          <div class="media align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="images/application/img-prod-2.jpg" alt="User image">
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="images/application/img-prod-3.jpg" alt="User image">
                            <div class="media-body mx-2">
                              <h5 class="mb-1">Canon EOS 1500D 24.1</h5>
                              <p class="text-muted text-sm mb-2">SLR Camera (Black) with EF</p>
                              <h5 class="mb-1"><b>$275</b><span
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="images/application/img-prod-4.jpg" alt="User image">
                            <div class="media-body mx-2">
                              <h5 class="mb-1">Canon EOS 1500D 24.1</h5>
                              <p class="text-muted text-sm mb-2">SLR Camera (Black) with EF</p>
                              <h5 class="mb-1"><b>$275</b><span
                                ...
                                <label class="form-check-label d-block" for="paycard-check-1">
                                  <span class="card-body p-3 d-block">
                                    <span class="d-flex align-items-start justify-content-between">
                                      ...
                                      <img src="images/application/mastercard.png" alt="images"
                                        class="img-fluid">
                                    </span>
                                ...
                                <label class="form-check-label d-block" for="paycard-check-2">
                                  <span class="card-body p-3 d-block">
                                    <span class="d-flex align-items-start justify-content-between">
                                      ...
                                      <img src="images/application/visa.png" alt="images" class="img-fluid">
                                    </span>
                                    <span class="row g-2 align-items-center justify-content-between mt-2 mb-5">
                                      <span class="col-auto">
                                        <span class="h5 mb-0">****</span>
                                ...
                                <label class="form-check-label d-block" for="payopn-check-1">
                                  <span class="card-body p-3 d-block">
                                    ...
                                    <span class="d-flex align-items-center">
                                      ...
                                      <img src="images/application/card.png" alt="img" class="img-fluid ms-1">
                                    </span>
                                  </span>
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                ...
                                <label class="form-check-label d-block" for="payopn-check-2">
                                  <span class="card-body p-3 d-block">
                                    ...
                                    <span class="d-flex align-items-center">
                                      <span class="f-12 badge bg-success me-3">5% OFF</span>
                                      <img src="images/application/paypal.png" alt="img"
                      ...
                      <div class="card-body">
                        <div class="row align-items-center">
                          ...
                          <div class="col-6 text-end">
                            <img src="images/application/img-coupon.png" alt="img" class="img-fluid">
                          </div>
                        </div>
                      </div>
                    </div>
