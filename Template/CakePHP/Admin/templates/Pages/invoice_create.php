...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Invoice Create')); ?>
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Invoice', 'breadcrumbitemactive' =>'Create')); ?>
                          ...
                          <div class="col-12">
                            <div class="row align-items-center justify-content-between g-3">
                              ...
                              <div class="col-sm-auto btn-page">
                                <a href="invoice-view" class="btn btn-primary">Preview</a>
