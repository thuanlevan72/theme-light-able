...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Rating')); ?>
  <link rel="stylesheet" href="/css/plugins/star-rating.min.css">
...
<?= $this->element('layout-vertical') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Forms', 'breadcrumbitemactive' =>'Rating')); ?>
  ...
  <script src="/js/plugins/star-rating.min.js"></script>
  <script>
