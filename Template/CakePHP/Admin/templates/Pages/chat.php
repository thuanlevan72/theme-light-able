...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Chat')); ?> <?= $this->element('head-css') ?> 
</head>
<!-- [Head] end -->
<!-- [Body] Start -->
                            ...
                            <div class="card-body p-0">
                              <div class="list-group list-group-flush">
                                <div class="list-group-item list-group-item-action p-3">
                                  <div class="media align-items-center">
                                    <div class="chat-avtar">
                                      <img class="rounded-circle img-fluid wid-40" src="images/user/avatar-1.jpg"
                                        alt="User image" />
                                ...
                                <div class="list-group-item list-group-item-action p-3">
                                  <div class="media align-items-center">
                                    <div class="chat-avtar">
                                      <img class="rounded-circle img-fluid wid-40" src="images/user/avatar-2.jpg"
                                        alt="User image" />
                                ...
                                <div class="list-group-item list-group-item-action p-3">
                                  <div class="media align-items-center">
                                    <div class="chat-avtar">
                                      <img class="rounded-circle img-fluid wid-40" src="images/user/avatar-3.jpg"
                                        alt="User image" />
                          ...
                          <div class="card-body p-0">
                            <div class="list-group list-group-flush">
                              ...
                              <div class="list-group-item">
                                <div class="media align-items-center">
                                  <div class="chat-avtar">
                                    <img class="rounded-circle img-fluid wid-40" src="images/user/avatar-5.jpg"
                                      alt="User image" />
                        ...
                        <div class="card bg-transparent shadow-none border-0 mb-0">
                          <div class="text-center card-body position-relative p-3 pb-0 px-0">
                            ...
                            <div class="chat-avtar d-inline-flex mx-auto">
                              <img class="rounded-circle img-fluid wid-100" src="images/user/avatar-5.jpg"
                                alt="User image" />
                            </div>
