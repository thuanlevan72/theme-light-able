...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Calendar')); ?>
...
<?= $this->element('body') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Application', 'breadcrumbitemactive' =>'Calendar')); ?>
  ...
  <!-- calender js -->
  <script src="js/plugins/index.global.min.js"></script>
  <!-- Sweet Alert -->
