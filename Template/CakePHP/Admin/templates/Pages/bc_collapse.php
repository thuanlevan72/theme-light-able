...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Collapse')); ?>
  ...
  <section class="component-block card-border-outside">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Collapse', 'text' =>'Toggle the visibility of content across your project with a few classes and our JavaScript plugins.', 'link' =>'https://getbootstrap.com/docs/5.2/components/collapse/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
