...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Utilities')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Utilities', 'text' =>'The utility API is a Sass-based tool to generate utility classes.', 'link' =>'https://getbootstrap.com/docs/5.2/utilities/background/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ Colored links ] start -->
