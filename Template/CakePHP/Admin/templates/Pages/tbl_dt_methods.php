...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Table Methods')); ?>
...
<?= $this->element('body') ?>
  ...
  <section class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Table', 'breadcrumbitemactive' =>'Table Methods')); ?>
  ...
  <script type="module">
    import { DataTable, convertJSON, convertCSV, exportCSV, exportSQL, exportJSON } from "/js/plugins/module.js"
