...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Badges')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Badges', 'text' =>'Documentation and examples for badges, our small count and labeling component.', 'link' =>'https://getbootstrap.com/docs/5.2/components/badge/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ badge ] start -->
