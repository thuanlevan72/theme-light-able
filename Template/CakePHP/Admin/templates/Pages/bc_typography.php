...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Typography')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Typography', 'text' =>'Documentation and examples for Bootstrap typography, including global settings, headings, body text, lists, and more.', 'link' =>'https://getbootstrap.com/docs/5.2/content/typography/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ Typography ] start -->
