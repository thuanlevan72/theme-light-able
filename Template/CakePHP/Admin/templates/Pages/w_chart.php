...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Chart Widget')); ?> <?= $this->element('head-css') ?> 
  </head>
  <!-- [Head] end -->
  <!-- [Body] Start -->
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Widget', 'breadcrumbitemactive' =>'Chart')); ?>
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
    ...
    <script src="js/pages/w-chart.js"></script>
