...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Statistics Widgets')); ?> <?= $this->element('head-css') ?> 
  </head>
  <!-- [Head] end -->
  <!-- [Body] Start -->
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Widget', 'breadcrumbitemactive' =>'Statistics')); ?>
        <div class="row">
          <!-- [ Row 1 ] start -->
          <div class="col-sm-6 col-xl-4">
            <div class="card statistics-card-1">
              ...
              <div class="card-body">
                <img src="images/widget/img-status-1.svg" alt="img" class="img-fluid img-bg h-100" >
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card statistics-card-1">
              ...
              <div class="card-body">
                <img src="images/widget/img-status-3.svg" alt="img" class="img-fluid img-bg" >
                <div class="d-flex align-items-center">
            ...
            <div class="card overflow-hidden">
              <div class="card-body bg-light-primary">
                <div class="row align-items-center">
                  ...
                  <div class="col-6">
                    <img src="images/widget/img-visitor.png" alt="img" class="img-fluid" >
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-xl-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-0">
                  <span class="text-success"><i class="ph-duotone ph-caret-up f-20 align-bottom"></i> +15%</span> last month
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 col-xl-8">
            <div class="card bg-brand-color-3 earning-card statistics-card-1">
              <div class="card-body overflow-hidden">
                <img src="images/widget/img-earning-bg.svg" alt="img" class="img-fluid img-bg h-100" >
          ...
          <div class="col-md-6 col-xl-4">
            <div class="card">
              <div class="card-body">
                <h6>Languages</h6>
                <p class="text-muted text-sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span class="badge bg-danger ms-2"><i class="ph-duotone ph-arrow-down me-1 align-middle"></i> 2.6%</span>
                </div>
              </div>
            </div>
          </div>
