...
<head>
    <?= $this->element('head-page-meta', array('title' => 'Peity Charts')); ?>
...
<?= $this->element('body') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Charts', 'breadcrumbitemactive' =>'Peity Charts')); ?>
  ...
  <script src="/js/plugins/peity-vanilla.min.js"></script>
  <script>
    peity.defaults.pie = {
      delimiter: null,
