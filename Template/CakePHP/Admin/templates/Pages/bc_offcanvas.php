...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Offcanvas')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Offcanvas', 'text' =>'Build hidden sidebars into your project for navigation, shopping carts, and more with a few classes and our JavaScript plugin.', 'link' =>'https://getbootstrap.com/docs/5.2/components/offcanvas/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
