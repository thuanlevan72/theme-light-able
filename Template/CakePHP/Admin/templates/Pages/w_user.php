...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'User Widgets')); ?> <?= $this->element('head-css') ?> 
  </head>
  <!-- [Head] end -->
  <!-- [Body] Start -->
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Widget', 'breadcrumbitemactive' =>'User')); ?>
        <div class="row">
          <!-- [ Row 1 ] start -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="border rounded p-3 my-3">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="images/user/avatar-1.jpg" alt="user-image" class="avtar rounded-circle wid-45 hei-45" >
                    </div>
