...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Toasts')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Toasts', 'text' =>'Push notifications to your visitors with a toast, a lightweight and easily customizable alert message.', 'link' =>'https://getbootstrap.com/docs/5.2/components/toasts/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ toasts ] start -->
                  ...
                  <div class="position-fixed top-0 end-0 p-3" style="z-index: 99999">
                    <div id="liveToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true">
                      <div class="toast-header">
                        <img src="images/favicon.svg" class="img-fluid m-r-5" alt="images"
                          style="width: 17px">
