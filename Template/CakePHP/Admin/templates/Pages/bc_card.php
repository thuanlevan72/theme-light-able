...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Cards')); ?>
  ...
  <section class="component-block card-border-outside">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Cards', 'text' =>'Bootstrap’s cards provide a flexible and extensible content container with multiple variants and options.', 'link' =>'https://getbootstrap.com/docs/5.2/components/card/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ card ] start -->
            ...
            <div class="col-md-6 col-xxl-4">
              ...
              <div class="pc-component">
                <div class="card mb-3">
                  <img class="img-fluid card-img-top" src="images/light-box/l3.jpg"
                    alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
            ...
            <div class="col-md-6 col-xxl-4">
              ...
              <div class="pc-component">
                <div class="card">
                  ...
                  <img class="img-fluid card-img-bottom" src="images/light-box/l3.jpg"
                    alt="Card image cap">
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xxl-4">
              ...
              <div class="pc-component">
                <div class="card bg-dark">
                  <img class="img-fluid card-img" src="images/light-box/l3.jpg" alt="Card image">
            ...
            <div class="col-xl-12">
              ...
              <div class="pc-component">
                <div class="card overflow-hidden">
                  <div class="row g-0">
                    <div class="col-md-4">
                      <img src="images/light-box/l3.jpg" class="img-fluid rounded-md-start" alt="...">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5 class="card-title">Card title</h5>
