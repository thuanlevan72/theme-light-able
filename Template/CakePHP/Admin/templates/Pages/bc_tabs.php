...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Tabs &amp; Pills')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Tabs &amp; Pills', 'text' =>'Takes the basic nav from above and adds the .nav-tabs class to generate a tabbed interface.', 'link' =>'https://getbootstrap.com/docs/5.2/components/navs-tabs/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ tabs ] start -->
