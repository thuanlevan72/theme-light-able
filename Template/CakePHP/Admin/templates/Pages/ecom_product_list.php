...
<html lang="en">
  ...
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Customer List')); ?> 
  ...
  <?= $this->element('body') ?>
    ...
    <div class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'E-commerce', 'breadcrumbitemactive' =>'Products list')); ?>
        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- [ sample-page ] start -->
          <div class="col-sm-12">
            <div class="card table-card">
              <div class="card-body">
                <div class="text-end p-sm-4 pb-sm-2">
                  <a href="ecom_product-add" class="btn btn-primary"> <i class="ti ti-plus f-18"></i> Add Product </a>
                </div>
                  ...
                  <table class="table table-hover tbl-product" id="pc-dt-simple">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="images/application/img-prod-1.jpg" alt="user-image" class="wid-40 rounded" >
                            </div>
                            <div class="col">
                        ...
                        <td class="text-center">
                          <img src="images/application/img-prod-brand-1.png" alt="user-image" class="wid-40" >
                          <div class="prod-action-links">
                            <ul class="list-inline me-auto mb-0">
                              ...
                              <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                                <a href="ecom_product-add" class="avtar avtar-xs btn-link-success btn-pc-default">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="images/application/img-prod-2.jpg" alt="user-image" class="wid-40 rounded" >
                            </div>
                            <div class="col">
                        ...
                        <td class="text-center">
                          <img src="images/application/img-prod-brand-2.png" alt="user-image" class="wid-40" >
                          <div class="prod-action-links">
                            <ul class="list-inline me-auto mb-0">
                              <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                <a
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="images/application/img-prod-3.jpg" alt="user-image" class="wid-40 rounded" >
                            </div>
                            <div class="col">
                        ...
                        <td class="text-center">
                          <img src="images/application/img-prod-brand-3.png" alt="user-image" class="wid-40" >
                          <div class="prod-action-links">
                            <ul class="list-inline me-auto mb-0">
                              <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                <a
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="images/application/img-prod-4.jpg" alt="user-image" class="wid-40 rounded" >
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Apple Series 4 GPS A38 MM Space</h6>
                              <p class="text-muted f-12 mb-0">Apple Watch SE Smartwatch </p>
                        ...
                        <td class="text-center">
                          <img src="images/application/img-prod-brand-4.png" alt="user-image" class="wid-40" >
                          <div class="prod-action-links">
                            <ul class="list-inline me-auto mb-0">
                              <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                <a
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="images/application/img-prod-5.jpg" alt="user-image" class="wid-40 rounded" >
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Boat On-Ear Wireless</h6>
                              <p class="text-muted f-12 mb-0">Mic(Bluetooth 4.2, Rockerz 450R</p>
                        ...
                        <td class="text-center">
                          <img src="images/application/img-prod-brand-5.png" alt="user-image" class="wid-40" >
                          <div class="prod-action-links">
                            <ul class="list-inline me-auto mb-0">
                              <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
                                <a
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item px-0">
            <div class="d-inline-flex align-items-center justify-content-between w-100">
              ...
              <h6 class="mb-0"><img src="images/application/img-prod-brand-1.png" alt="user-image" class="wid-40"></h6>
            </div>
          </li>
        </ul>
      </div>
