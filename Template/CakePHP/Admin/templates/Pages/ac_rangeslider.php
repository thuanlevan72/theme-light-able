...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Range Slider')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Range Slider', 'text' =>'Create an input element in the DOM, and then create an instance of Slider', 'link' =>'https://seiyria.com/bootstrap-slider/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ rangeslider ] start -->
