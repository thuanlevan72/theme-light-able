        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1 overflow-hidden ">
              <div class="card-body">
                <img src="images/widget/img-status-4.svg" alt="img" class="img-fluid img-bg" >
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1 overflow-hidden ">
              <div class="card-body">
                <img src="images/widget/img-status-5.svg" alt="img" class="img-fluid img-bg" >
          ...
          <div class="col-md-4 col-sm-12">
            <div class="card statistics-card-1 overflow-hidden  bg-brand-color-3">
              <div class="card-body">
                <img src="images/widget/img-status-6.svg" alt="img" class="img-fluid img-bg" >
          ...
          <div class="col-md-6 col-xl-4">
            <div class="card statistics-card-1 overflow-hidden ">
              <div class="card-body">
                <img src="images/widget/img-status-7.svg" alt="img" class="img-fluid img-bg" >
                <div class="media align-items-center">
                  <img src="images/widget/img-facebook.svg" alt="img" class="img-fluid" >
                  <div class="media-body ms-3">
          ...
          <div class="col-md-6 col-xl-4">
            <div class="card statistics-card-1 overflow-hidden ">
              <div class="card-body">
                <img src="images/widget/img-status-8.svg" alt="img" class="img-fluid img-bg" >
                <div class="media align-items-center">
                  <img src="images/widget/img-google.svg" alt="img" class="img-fluid" >
                  <div class="media-body ms-3">
                    <p class="mb-0 text-muted">Total Likes</p>
                    <div class="d-inline-flex align-items-center">
                      <h5 class="f-w-300 d-flex align-items-center m-b-0">12,281</h5>
          ...
          <div class="col-md-12 col-xl-4">
            <div class="card statistics-card-1 overflow-hidden ">
              <div class="card-body">
                <img src="images/widget/img-status-9.svg" alt="img" class="img-fluid img-bg" >
                <div class="media align-items-center">
                  <img src="images/widget/img-twitter.svg" alt="img" class="img-fluid" >
                  <div class="media-body ms-3">
                    <p class="mb-0 text-muted">Total Likes</p>
                    <div class="d-inline-flex align-items-center">
                      <h5 class="f-w-300 d-flex align-items-center m-b-0">12,281</h5>
