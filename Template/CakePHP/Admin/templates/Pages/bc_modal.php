...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Modal')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Modal', 'text' =>'Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for lightboxes, user notifications, or completely custom content.', 'link' =>'https://getbootstrap.com/docs/5.2/components/modal/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ demo-modal ] start -->
