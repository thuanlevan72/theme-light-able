...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Account Profile 1')); ?> <?= $this->element('head-css') ?> 
</head>
<!-- [Head] end -->
<!-- [Body] Start -->
...
<?= $this->element('body') ?>
  ...
  <div class="pc-container">
    <div class="pc-content">
      <?= $this->element('breadcrumb', array('breadcrumbitem' => 'Users', 'breadcrumbitemactive' =>'Account Profile')); ?>
      <!-- [ Main Content ] start -->
      <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-sm-12">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                  <img src="images/application/img-accout-alert.png" alt="img" class="img-fluid wid-80">
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="text-center mt-3">
                    <div class="chat-avtar d-inline-flex mx-auto">
                      <img class="rounded-circle img-fluid wid-90 img-thumbnail"
                        src="images/user/avatar-1.jpg" alt="User image">
                  ...
                  <div class="card alert alert-warning p-0">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                          <img src="images/application/img-accout-password-alert.png" alt="img"
