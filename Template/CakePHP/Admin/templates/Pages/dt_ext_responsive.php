...
<html lang="en">
  <!-- [Head] start -->
  <head>
    <?= $this->element('head-page-meta', array('title' => 'Responsive DataTable')); ?>
    <!-- [Page specific CSS] start -->
    <!-- data tables css -->
    <link rel="stylesheet" href="css/plugins/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="css/plugins/responsive.bootstrap5.min.css">
  ...
  <?= $this->element('body') ?>
    ...
    <section class="pc-container">
      <div class="pc-content">
        <?= $this->element('breadcrumb', array('breadcrumbitem' => 'DataTable', 'breadcrumbitemactive' =>'Responsive')); ?>
    ...
    <script src="js/plugins/responsive.bootstrap5.min.js"></script>
    <script>
