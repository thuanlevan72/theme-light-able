...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Syntax Highlighter')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Syntax Highlighter', 'text' =>'Prism is a lightweight, extensible syntax highlighter, built with modern web standards in mind. It’s used in millions of websites, including some of those you visit daily.', 'link' =>'https://prismjs.com/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ Basic-Usage ] start -->
