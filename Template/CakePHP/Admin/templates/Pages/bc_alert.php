...
<head>
  <?= $this->element('head-page-meta', array('title' => 'Alerts')); ?>
  ...
  <section class="component-block">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-9">
          <div class="row">
            <?= $this->element('component-breadcrumb', array('title' => 'Alerts', 'text' =>'Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.', 'link' =>'https://getbootstrap.com/docs/5.2/components/alerts/')); ?>
          </div>
          <!-- [ Main Content ] start -->
          <div class="row">
            <!-- [ basic-alert ] start -->
